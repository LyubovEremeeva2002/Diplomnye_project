...
<div class="container">
  <div class="frame">
    ...
    <div ng-app ng-init="checked = false">
          ...
          <label for="checkbox" ><span class="ui"></span>Сохранить пароль</label>
          ...
          <a ng-click="checked = !checked" class="btn-signup">Зарегестрироваться</a>
                </form>
       ...
       viewBox="0 0 60 60" id="check" ng-class="checked ? 'checked' : ''">
                ...
                <div class="successtext">
                   <p> Благодарим Вас, вы успешло зарегестрировались!</p>
                </div>
             </div>
      </div>
      ...
      <div>
        ...
        <a class="btn-goback" value="Refresh" onClick="history.go()">Продолжить</a>
      </div>
  </div>
